...
async def pcalculate(ctx):
    ...
    try:
        ...
        await ctx.send(
            ...
            "Example: `0.264`, `0.264s`, `30s`, or `1m`"
        )
        ...
        embed.add_field(name="Power Needed", value=format_game_number(needed), inline=True)
        embed.add_field(name="Ticks Needed", value=f"{ticks_needed:,}", inline=True)
